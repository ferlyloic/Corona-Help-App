...
class CategoriesListWidget extends StatefulWidget {
  ...
  const CategoriesListWidget({Key key, this.setChosenCategory})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    for (ServiceCategory cat in categoryList) {
      categoryWidgetList.add(CategoryWidget(
          setChosenCategory: widget.setChosenCategory, category: cat));
    }
    return Column(children: categoryWidgetList);
  }
}
...
class CategoryWidget extends StatelessWidget {
  ...
  const CategoryWidget({Key key, this.category, this.setChosenCategory})
      : super(key: key);
